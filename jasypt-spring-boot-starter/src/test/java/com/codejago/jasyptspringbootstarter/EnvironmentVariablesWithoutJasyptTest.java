...
@SpringBootTest(classes = EnvironmentVariablesWithoutJasyptTest.TestConfig.class)
public class EnvironmentVariablesWithoutJasyptTest {
    ...
    @EnableConfigurationProperties(EnvironmentVariablesWithoutJasyptTest.MyProperties.class)
