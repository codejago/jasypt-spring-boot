package com.codejago.jasyptmavenplugin.mojo;

import com.codejago.jasyptmavenplugin.encrypt.EncryptionService;
...
public abstract class AbstractReencryptMojo extends AbstractFileJasyptMojo {
     ...
     * <p>configure.</p>
     *
     * @param properties a {@link com.codejago.jasyptspringboot.properties.JasyptEncryptorConfigurationProperties} object
     */
