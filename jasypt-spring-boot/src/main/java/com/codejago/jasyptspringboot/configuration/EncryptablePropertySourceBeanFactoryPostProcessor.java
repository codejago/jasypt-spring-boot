...
import com.codejago.jasyptspringboot.annotation.EncryptablePropertySources;
import com.codejago.jasyptspringboot.wrapper.EncryptableEnumerablePropertySourceWrapper;
import com.codejago.jasyptspringboot.wrapper.OriginTrackedCompositePropertySource;
...
import static com.codejago.jasyptspringboot.configuration.EncryptablePropertyResolverConfiguration.FILTER_BEAN_NAME;
import static com.codejago.jasyptspringboot.configuration.EncryptablePropertyResolverConfiguration.RESOLVER_BEAN_NAME;
...
public class EncryptablePropertySourceBeanFactoryPostProcessor implements BeanFactoryPostProcessor, Ordered {
    ...
    private Stream<AnnotationAttributes> getEncryptablePropertySourcesMetadata(ConfigurableListableBeanFactory beanFactory) {
        return getBeanDefinitionsForAnnotation(beanFactory, com.codejago.jasyptspringboot.annotation.EncryptablePropertySource.class, EncryptablePropertySources.class);
    }
