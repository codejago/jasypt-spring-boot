...
- Frameworks: Spring Boot 4.0.x, Jasypt 1.9.3.
...
- jasypt-spring-boot-starter: starter wiring for auto-configuration; keep metadata files (`spring.factories`, `AutoConfiguration.imports`) consistent with class names and keep tests green.
